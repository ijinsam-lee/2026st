    ...
    with c_2026:
        ...
        with st.expander("📖 2026년 혼합전략 상세 운용원칙 및 기대성과"):
            ...
            * **전략C (33.33%)**: S&P 500 배당수익률 기반 주도 섹터 로테이션 포트폴리오 (중간형)
            ...
            col_perf1.metric("예상 연평균수익률 (CAGR)", "25% ~ 28%")
            col_perf2.metric("예상 최대낙폭 (MDD)", "-8% ~ -12%")
            col_perf3.metric("예상 샤프 지수 (Sharpe)", "1.80 내외")
    ...
    with c_a:
        ...
        with st.expander("📖 전략 A 상세 운용원칙 및 기대성과"):
            ...
            * **2단계 (공격/방어 자산 매수)**:
            ...
            ### 📈 역사적 백테스트 지표 (2018년 이후)
            """)
            col_a1, col_a2, col_a3 = st.columns(3)
            col_a1.metric("연평균 수익률 (CAGR)", "22.6%")
            col_a2.metric("최대 낙폭 (MDD)", "-6.1%")
            col_a3.metric("샤프 지수 (Sharpe)", "2.02")
    ...
    with c_b:
        ...
        with st.expander("📖 전략 B 상세 운용원칙 및 기대성과"):
            ...
            * **2단계 (자산 선택)**:
            ...
            col_b1.metric("연평균 수익률 (CAGR)", "36.8%")
            col_b2.metric("최대 낙폭 (MDD)", "-27.8%")
            col_b3.metric("샤프 지수 (Sharpe)", "1.32")
